...
public class DownInfo {
    ...
    public DownStateEnum getState() {
        switch (getStateInte()) {
            case 0:
                return DownStateEnum.START;
            case 1:
                return DownStateEnum.DOWN;
            case 2:
                return DownStateEnum.PAUSE;
            case 3:
                return DownStateEnum.STOP;
            case 4:
                return DownStateEnum.ERROR;
            case 5:
            default:
                return DownStateEnum.FINISH;
        }
    }
