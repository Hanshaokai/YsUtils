...
public class IntentUtils {
    ...
    public static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = BuildConfig.applicationId;
...
*/
   ...
   /* *//**
     ...
     * @return
     */
    public static Intent getTxtOpenIntent(String authority, File file) {
        //此方法在7.0 上找不到文件 跳转到第三方App 打不开
       /* Intent intent = new Intent();
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = RiqingFileProvider.getUriForFile(Utils.getApp(), authority, file);
        }
        intent.setDataAndType(data, "application/vnd.openxmlformats-officedocument.wordprocessingml.document");
