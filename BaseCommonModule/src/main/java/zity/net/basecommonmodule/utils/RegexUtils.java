...
public final class RegexUtils {
    ...
    /**
     * 输入密码是不是8-16 字母加数字的组合
     *
     * @param input
     * @return
     */
    public static boolean psswordIsQualified(final CharSequence input) {
        return isMatch(RegexConstants.PASSWORD_REGEX, input);
    }
